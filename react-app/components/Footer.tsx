...
const links = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/bobman7000',
      icon: (props: Props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/bobeu/coinpicker',
      icon: (props: Props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  export default function Footer(props: {scrollToSection: (arg: SectionId) => void, activeLink: SectionId}) {
